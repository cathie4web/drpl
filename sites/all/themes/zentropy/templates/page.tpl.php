	...
	<div id="page" class="page">
		...
		<header id="header" class="header page-header clearfix" role="banner">
			...
			if ( $page['header_bottom'] ) : 
				zentropy_region_preffix ( 'header_bottom' );
					print render( $page['header_bottom'] );
				zentropy_region_suffix ( 'header_bottom' );
			endif; ?>
		</header>
		...
		<div id="main-wrapper" class="main-wrapper" role="main">
			<?php // Region content top
			if ( $page['content_top'] ) : 
				zentropy_region_preffix ( 'content_top' );
					print render( $page['content_top'] );
				zentropy_region_suffix ( 'content_top' );
			endif; ?>
				...
				<div class="grid-12">
					<div id="main" class="main clearfix">
						...
						<div id="content" class="content content-main <?php if ( ( $page['sidebar_first'] ) && ( $page['sidebar_second'] ) ) : print 'grid-4'; elseif ( $page['sidebar_first'] ) : print 'grid-8 omega'; elseif ( $page['sidebar_second'] ) : print 'grid-8 alpha'; endif; ?>">
							<?php if ( !empty( $page['highlighted'] ) || $breadcrumb || ( $title && !$is_front ) || !empty( $tabs['#primary'] ) || !empty( $action_links ) || !empty( $page['help'] ) || $messages ) : ?>
			...
			<?php if ( $page['content_bottom'] ) : 
				zentropy_region_preffix ( 'content_bottom' );
					print render( $page['content_bottom'] );
				zentropy_region_suffix ( 'content_bottom' );
			endif; ?>
		</div>
