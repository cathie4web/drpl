...
(function($) {
	...
	var Kwick = function Kwick(container, opts) {
		...
		//this.primaryDimension = opts.isVertical ? 'height' : 'width'; i=0;
		if(opts.isVertical) this.primaryDimension='height';
		else this.primaryDimension='width';
	...
	Kwick.prototype.initSlideshowBehavior = function() {
		...
		this.addEventHandler(this.$container, 'click', pause);
		this.addEventHandler(this.$container, 'click', start);
		this.addEventHandler(this.$panels, 'click', function() {
