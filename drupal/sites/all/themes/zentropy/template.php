...
function zentropy_preprocess_html( &$vars ) {
	...
	if ( ( $d['destination'] == 'blog' ) && ( theme_get_setting( 'zentropy_blog_title' ) != "" ) ) {
		$vars['title'] = theme_get_setting( 'zentropy_blog_title' );
		$vars['head_title'] = theme_get_setting( 'zentropy_blog_title' );
	}
}
 ...
 * @ingroup themeable
 */
function zentropy_menu_link( array $vars ) {
	...
	$element['#attributes']['class'][] = zentropy_id_safe( $element['#title'] );
 ...
 */
function zentropy_preprocess_menu_local_task( &$vars ) {
 ...
 */
function zentropy_menu_local_tasks( &$vars ) {
	$output = '';
...
/* Region options */
function zentropy_region_preffix ( $reg ) {
	$block_bg_type = theme_get_setting( 'zentropy_' . $reg . '_bg_type' );
	$block_bg_img = theme_get_setting( 'zentropy_' . $reg . '_bg_img' );
	$block_bg_parallax = theme_get_setting( 'zentropy_' . $reg . '_bg_parallax' );
	$bg_video = theme_get_setting( 'zentropy_' . $reg . '_bg_video' );
	$bg_video_start = theme_get_setting( 'zentropy_' . $reg . '_bg_video_start' );
	$fullwidth = theme_get_setting( 'zentropy_' . $reg . '_fullwidth' );
...
function zentropy_region_suffix ( $reg ) {
	$fullwidth = theme_get_setting( 'zentropy_' . $reg . '_fullwidth' );
	$block_bg_parallax = theme_get_setting( 'zentropy_' . $reg . '_bg_parallax' );
	$block_bg_img = theme_get_setting( 'zentropy_' . $reg . '_bg_img' );
...
function zentropy_form_contact_site_form_alter( &$form, &$form_state, $form_id ) {
	...
	//$form['subject']['#element_validate'] = array( '_zentropy_empty_field' );
...
/*function _zentropy_empty_field ( $element, &$form_state ) {
