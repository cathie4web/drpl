...
<?php if ( !theme_get_setting( 'zentropy_breadcrumb_show' ) ) :
	$breadcrumb = NULL;
endif; ?>
	...
	<div id="page" class="page">
		...
		<div id="main-wrapper" class="main-wrapper" role="main">
			...
			<?php if ( $page['section_1'] ) : 
				zentropy_region_preffix ( 'section_1' );
					print render( $page['section_1'] );
				zentropy_region_suffix ( 'section_1' );
			endif; ?>
			
			<!-- Region Section 2 -->
			<?php if ( $page['section_2'] ) : 
				zentropy_region_preffix ( 'section_2' );
					print render( $page['section_2'] );
				zentropy_region_suffix ( 'section_2' );
			endif; ?>
			
			<!-- Region Section 3 -->
			<?php if ( $page['section_3'] ) : 
				zentropy_region_preffix ( 'section_3' );
					print render( $page['section_3'] );
				zentropy_region_suffix ( 'section_3' );
			endif; ?>
			
			<!-- Region Section 4 -->
			<?php if ( $page['section_4'] ) : 
				zentropy_region_preffix ( 'section_4' );
					print render( $page['section_4'] );
				zentropy_region_suffix ( 'section_4' );
			endif; ?>
			
			<!-- Region Section 5 -->
			<?php if ( $page['section_5'] ) : 
				zentropy_region_preffix ( 'section_5' );
					print render( $page['section_5'] );
				zentropy_region_suffix ( 'section_5' );
			endif; ?>
			
			<!-- Region Section 6 -->
			<?php if ( $page['section_6'] ) : 
				zentropy_region_preffix ( 'section_6' );
					print render( $page['section_6'] );
				zentropy_region_suffix ( 'section_6' );
			endif; ?>
			
			<!-- Region Section 7 -->
			<?php if ( $page['section_7'] ) : 
				zentropy_region_preffix ( 'section_7' );
					print render( $page['section_7'] );
				zentropy_region_suffix ( 'section_7' );
			endif; ?>
			
			<!-- Region Section 8 -->
			<?php if ( $page['section_8'] ) : 
				zentropy_region_preffix ( 'section_8' );
					print render( $page['section_8'] );
				zentropy_region_suffix ( 'section_8' );
			endif; ?>
			
			<!-- Region Section 9 -->
			<?php if ( $page['section_9'] ) : 
				zentropy_region_preffix ( 'section_9' );
					print render( $page['section_9'] );
				zentropy_region_suffix ( 'section_9' );
			endif; ?>
			
			<!-- Region Section 10 -->
			<?php if ( $page['section_10'] ) : 
				zentropy_region_preffix ( 'section_10' );
					print render( $page['section_10'] );
				zentropy_region_suffix ( 'section_10' );
			endif; ?>
		</div>
		...
		<footer id="footer" class="footer page-footer" role="contentinfo">
			...
			<?php if ( $page['footer_top'] ) : 
				zentropy_region_preffix ( 'footer_top' );
					print render( $page['footer_top'] );
				zentropy_region_suffix ( 'footer_top' );
			endif; ?>
