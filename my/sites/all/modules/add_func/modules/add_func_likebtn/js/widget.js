if (typeof(LikeBtn) == "undefined" || !LikeBtn) {
	...
	var LikeBtn = function(window_obj) {
		...
		obj.settings.default_values = {
			...
			loader_image: "",
			tooltip_enabled: 1,
			tooltip_like_show_always: 0,
			tooltip_dislike_show_always: 0,
			white_label: 0,
			popup_enabled: 1,
			popup_position: "top",
			popup_style: "light",
		...
		obj.translations = {
			...
			de: {
				...
				i18n_unlike_tooltip: "Stornieren",
				i18n_undislike_tooltip: "Stornieren",
			...
			/*ja: {
				...
				i18n_popup_text: "気に入っていただいてありがとうございます。",
			...
			uk: {
				...
				i18n_popup_text: "Ради, що вам сподобалося!",
				i18n_popup_donate: "Віддячити рублем"
			},
			kk: {
				i18n_like: "Ұнайды",
			...
			hu: {
				...
				i18n_like_tooltip: "Én kedvelem ezt",
				i18n_dislike_tooltip: "Nekem ez nem tetszik",
				i18n_unlike_tooltip: "Mégsem tetszik",
				i18n_undislike_tooltip: "Mégsem nem tetszik",
				i18n_share_text: "Megszeretnéd osztani?",
				i18n_popup_close: "Bezár",
				i18n_popup_text: "Örülünk, hogy tetszett!",
				i18n_popup_donate: "Adományoz"
			},
			sv: {
				i18n_like: "Gilla",
				i18n_dislike: "Ogilla",
			...
			tr: {
				...
				i18n_like_tooltip: "Beğen",
				i18n_dislike_tooltip: "Beğenme",
				i18n_unlike_tooltip: "Beğendin",
				i18n_undislike_tooltip: "Beğenmedin",
			...
			es: {
				...
				i18n_unlike_tooltip: "Quitar el me gusta",
				i18n_undislike_tooltip: "Quitar el no me gusta",
				i18n_share_text: "¿Desea compartir?",
			...
			pt: {
				i18n_like: "Obrigado",
				i18n_dislike: "Que Pena",
				i18n_after_like: "Obrigado",
				i18n_after_dislike: "Que Pena",
				i18n_like_tooltip: "Gostei",
				i18n_dislike_tooltip: "Não Gostei",
				i18n_unlike_tooltip: "Poxa",
				i18n_undislike_tooltip: "Que Legal",
				i18n_share_text: "Você gostaria de compartilhar?",
				i18n_popup_close: "Tchau",
			...
			vi: {
				...
				i18n_like_tooltip: "Bạn thích điều này",
			...
			fr: {
				...
				i18n_unlike_tooltip: "Retirer J'aime",
			...
			/*it: {
				...
				i18n_unlike_tooltip: "Non mi piace",
				i18n_undislike_tooltip: "Mi piace",
				i18n_share_text: "Vuoi condividere?",
				i18n_popup_close: "Chiudi",
				i18n_popup_text: "Sono felice che ti sia piaciuto!",
			...
			he: {
				...
				i18n_unlike_tooltip: "בעצם לא אוהבת",
				i18n_undislike_tooltip: "בעצם אהבתי",
				i18n_share_text: "לשתף?",
				i18n_popup_close: "סגירה",
				i18n_popup_text: "טוב שאהבת",
		...
		obj.dyn_settings = { values: [] };
		//obj.plans = { TRIAL: 9, FREE: 0, PLUS: 1, PRO: 2, VIP: 3, ULTRA: 4 };
		...
		obj.setCountsData = function(index, identifier_hash) {
			...
			var cookie_count = { "1": count_like, "-1": count_dislike };
			if (!identifier_hash) {
		...
		obj.getHtml = function(data, index) {
			...
			if (settings.like_enabled || !settings.dislike_enabled) {
				...
				lb_html += "<span " + ((!settings.counter_clickable && settings.voting_enabled) ? 'onclick = "LikeBtn.vote(1, ' + index + ');"' : "") + ' class = "lb-a">';
		...
		/*obj.getPaymentSystemHtml = function(system, purpose) {
			...
			switch(system.system) {
				...
				case "Google Wallet":
					...
					break;
				case "Yandex.Money":
					href = "https: //money.yandex.ru/quickpay/confirm.xml?quickpay-form = donate&receiver = " + escape(system.account) + "&sum = " + escape(amount);
					break;
		...
		obj.popupShow = function(index, type) {
			...
			if (popup_el && obj.isDefined(popup_el[0])) {
				...
				if (a_el && obj.isDefined(a_el[0])) {
					...
					popup_content += '<i class = "lb-share-tt-ft"><a class = "lb-share-tt-tm" href = "http: //likebtn.com" target = "_blank" style = "display: inline !important">&copy;LikeBtn.com</a>';
					...
					if (popup_html) {
						obj.stripAndExecuteScript(obj.replaceAll(/&quot;/, '"', popup_html))
					}
					var cr_el = [];
					if (type == 1) {
		...
		obj.infoMessage = function(index, wrapper, message) {
			wrapper.innerHTML = '<a href = "http: //likebtn.com" title = "Like Button">LikeBtn.com</a> [<a href = "javascript: void(0);" onclick = "this.outerHTML = LikeBtn.Base64.decode(\'' + obj.Base64.encode(message) + "');\">?</a>]";
		...
		obj.triggerEvent = function(event_type, index) {
			...
			var callback;
			var event = { type: "", settings: {}, wrapper: null };
