			...
			<?php if ( $display_submitted ) : ?>
				<div class="submitted node-submitted" role="contentinfo">
					...
					<?php if ( $submitted ) : // node author ?>
						<span class="node-author"><span class="fa fa-user"></span> <?php print $submitted; ?></span>
					<?php endif;

					if ( $submitted_pubdate ) : // publish date ?>
						<time class="node-time" datetime="<?php print $submitted_pubdate; ?>">
							<span class="fa fa-calendar"></span> <?php print $submitted_date; ?>
						</time>
					<?php endif; ?>
					...
					<?php if ( $teaser ) : // number of comments ?>
						...
						<a href="<?php echo $node_url;?>#comments" class="node-comments"><?php print $comment_count . t( " comment(s)" ); ?> </a>
					<?php endif; ?>
				</div>
			<?php endif; ?>
		</header>
