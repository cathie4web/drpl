...
function zentropy_region_preffix ( $reg ) {
	$block_bg_type = theme_get_setting( 'theme941_' . $reg . '_bg_type' );
	$block_bg_img = theme_get_setting( 'theme941_' . $reg . '_bg_img' );
	$block_bg_parallax = theme_get_setting( 'theme941_' . $reg . '_bg_parallax' );
	$bg_video = theme_get_setting( 'theme941_' . $reg . '_bg_video' );
	$bg_video_start = theme_get_setting( 'theme941_' . $reg . '_bg_video_start' );
	$fullwidth = theme_get_setting( 'theme941_' . $reg . '_fullwidth' );
